...
───┼───┼───┼───┼───
 1 │ 3 │ 4 │ ❎│ ❎
───┴───┴───┴───┴───
`)])],-1),_=e("code",null,"c",-1),m=e("code",null,"d",-1),b=e("code",null,"second",-1),p=e("code",null,"group",-1),w=e("code",null,"flatten",-1),x=r(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; let first = [[a b]; [1 2] [3 4]]
&gt; let second = [[c d]; [3 4]]
...
───┼───┼───┼───┼───┼───┼───
 1 │ 3 │ 4 │ 5 │ 6 │ 7 │ 8
───┴───┴───┴───┴───┴───┴───
</code></pre></div>`,5),k=e("code",null,"reduce",-1),v=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> [$first_table $second_table $third_table]|reduce {|it, acc|
    $acc
    | group ($it | length)
    | each {|x|
        merge {$it}
