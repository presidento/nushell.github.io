import{_ as a,r as s,o,c as i,a as n,b as p,d as e,e as c}from"./app.61ce1ff2.js";const l={},r=n("h1",{id:"reedline-nu-s-line-editor",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#reedline-nu-s-line-editor","aria-hidden":"true"},"#"),e(" Reedline, Nu's line editor")],-1),d=e("Nushell's line editor "),u={href:"https://github.com/nushell/reedline",target:"_blank",rel:"noopener noreferrer"},h=e("Reedline"),m=e(" is a cross-platform line reader designed to be modular and flexible. The engine is in charge of controlling the command history, validations, completions, hints and screen paint."),k=c(`<h2 id="configuration" tabindex="-1"><a class="header-anchor" href="#configuration" aria-hidden="true">#</a> Configuration</h2><h3 id="editing-mode" tabindex="-1"><a class="header-anchor" href="#editing-mode" aria-hidden="true">#</a> Editing mode</h3><p>Reedline allows you to edit text using two modes: vi and emacs. If not specified, the default edit mode is emacs mode. In order to select your favorite you need to modify your config file and write down your preferred mode.</p><p>For example:</p><div class="language-bash ext-sh"><pre class="language-bash"><code>  <span class="token builtin class-name">let</span> <span class="token variable">$config</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
    <span class="token punctuation">..</span>.
    edit_mode: emacs
    <span class="token punctuation">..</span>.
  <span class="token punctuation">}</span>
