...
</code></pre></div><p>Use ansi to color text (rb = red bold, gb = green bold, pb = purple bold)</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">$&#39;(ansi rb)Hello (ansi gb)Nu (ansi pb)World(ansi reset)&#39;</span>
...
</code></pre></div>`,17);function b(a,m){return o(),r("div",null,[e("h1",c,[p,d,e("code",null,n(a.$frontmatter.title),1),u]),e("div",h,n(a.$frontmatter.platform),1),g])}const k=t(l,[["render",b],["__file","ansi.html.vue"]]);export{k as default};
