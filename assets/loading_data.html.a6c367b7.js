...
`)])],-1),J=e("p",null,[t("You might notice it is quite similar to JSON, and you're right. "),e("strong",null,"NUON is a superset of JSON!"),t(' That is, any JSON code is a valid NUON code, therefore a valid Nushell code. Compared to JSON, NUON is more "human-friendly". For example, comments are allowed and commas are not required.')],-1),E=t("One limitation of NUON currently is that it cannot represent all of the Nushell "),P=t("data types"),z=t(". Most notably, NUON does not allow to serialize blocks."),F=a(`<h2 id="handling-strings" tabindex="-1"><a class="header-anchor" href="#handling-strings" aria-hidden="true">#</a> Handling Strings</h2><p>An important part of working with data coming from outside Nu is that it&#39;s not always in a format that Nu understands. Often this data is given to us as a string.</p><p>Let&#39;s imagine that we&#39;re given this data file:</p><div class="language-text ext-text"><pre class="language-text"><code>&gt; open people.txt
...
\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
</code></pre></div>`,7),M=t("We can see that we're working with the lines because we're back into a table. Our next step is to see if we can split up the rows into something a little more useful. For that, we'll use the "),Q=e("code",null,"split",-1),H=t(" command. "),G=e("code",null,"split",-1),Y=t(", as the name implies, gives us a way to split a delimited string. We will use "),D=e("code",null,"split",-1),K=t("'s "),X=e("code",null,"column",-1),Z=t(" subcommand to split the contents across multiple columns. We tell it what the delimiter is, and it does the rest:"),$=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`> open people.txt | lines | split column "|"
\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
...
\u2500\u2500\u2500\u253C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u253C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u253C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
 ...
 2 \u2502 Antonio  \u2502  Vivaldi  \u2502  Composer
\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
`)])],-1),ee=t("That "),te=e("em",null,"almost",-1),oe=t(" looks correct. It looks like there's an extra space there. Let's "),ne=e("code",null,"trim",-1),se=t(" that extra space:"),ae=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`> open people.txt | lines | split column "|" | str trim
\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
 # \u2502 column1 \u2502 column2 \u2502 column3
\u2500\u2500\u2500\u253C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u253C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u253C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
 0 \u2502 Octavia \u2502 Butler  \u2502 Writer
 ...
 2 \u2502 Antonio \u2502 Vivaldi \u2502 Composer
\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
`)])],-1),le=t("Not bad. The "),ie=e("code",null,"split",-1),de=t(" command gives us data we can use. It also goes ahead and gives us default column names:"),ce=a(`<div class="language-text ext-text"><pre class="language-text"><code>&gt; open people.txt | lines | split column &quot;|&quot; | str trim | get column1
\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
 0 \u2502 Octavia
 1 \u2502 Bob
 2 \u2502 Antonio
...
license = "MIT"
`)])],-1),we=e("h2",{id:"sqlite",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#sqlite","aria-hidden":"true"},"#"),t(" SQLite")],-1),ve={class:"custom-container warning"},ke=e("p",{class:"custom-container-title"},"WARNING",-1),ye=t("To use the SQLite support you need a fully-featured build with "),Ne=e("code",null,"cargo build --features extra",-1),Oe=t(". Most binary releases like the one provided via "),qe={href:"https://github.com/nushell/nushell/releases",target:"_blank",rel:"noopener noreferrer"},Te=t("GitHub"),Be=t(" should already include this. "),Le=t("See the installation instructions"),Se=t(" for further details."),Ce=t("SQLite databases are automatically detected by "),je=e("code",null,"open",-1),Re=t(", no matter what their file extension is. You can open a whole database:"),Ie=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`> open foo.db
`)])],-1),We=t("Or "),Ue=e("code",null,"get",-1),Ae=t(" a specific table:"),Ve=a(`<div class="language-text ext-text"><pre class="language-text"><code>&gt; open foo.db | get some_table
...
</code></pre></div><p>(Note: some older versions of Nu use <code>into db | query</code> instead of <code>query db</code> )</p><h2 id="fetching-urls" tabindex="-1"><a class="header-anchor" href="#fetching-urls" aria-hidden="true">#</a> Fetching URLs</h2>`,5),Je=t("In addition to loading files from your filesystem, you can also load URLs by using the "),Ee=e("code",null,"fetch",-1),Pe=t(" command. This will fetch the contents of the URL from the internet and return it:"),ze=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`> fetch https://blog.rust-lang.org/feed.xml
\u2500\u2500\u2500\u2500\u2500\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
 feed \u2502 {record 2 fields}
\u2500\u2500\u2500\u2500\u2500\u2500\u2534\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
`)])],-1);function Fe(Me,Qe){const n=i("RouterLink"),l=i("ExternalLinkIcon");return c(),r("div",null,[h,e("p",null,[m,o(n,{to:"/book/commands/ls.html"},{default:s(()=>[p]),_:1}),_,o(n,{to:"/book/commands/ps.html"},{default:s(()=>[g]),_:1}),f,o(n,{to:"/book/commands/date.html"},{default:s(()=>[x]),_:1}),b,o(n,{to:"/book/commands/sys.html"},{default:s(()=>[w]),_:1}),v]),k,e("p",null,[y,o(n,{to:"/book/commands/open.html"},{default:s(()=>[N]),_:1}),O]),q,e("p",null,[T,o(n,{to:"/book/commands/ls.html"},{default:s(()=>[B]),_:1}),L]),e("p",null,[S,o(n,{to:"/book/commands/get.html"},{default:s(()=>[C]),_:1}),j]),R,e("p",null,[I,e("a",W,[U,o(l)]),A]),V,J,e("p",null,[E,o(n,{to:"/book/types_of_data.html"},{default:s(()=>[P]),_:1}),z]),F,e("p",null,[M,o(n,{to:"/book/commands/split.html"},{default:s(()=>[Q]),_:1}),H,o(n,{to:"/book/commands/split.html"},{default:s(()=>[G]),_:1}),Y,o(n,{to:"/book/commands/split.html"},{default:s(()=>[D]),_:1}),K,X,Z]),$,e("p",null,[ee,te,oe,o(n,{to:"/book/commands/str_trim.html"},{default:s(()=>[ne]),_:1}),se]),ae,e("p",null,[le,o(n,{to:"/book/commands/split.html"},{default:s(()=>[ie]),_:1}),de]),ce,e("ul",null,[re,e("li",null,[o(n,{to:"/book/commands/lines.html"},{default:s(()=>[ue]),_:1})]),e("li",null,[o(n,{to:"/book/commands/size.html"},{default:s(()=>[he]),_:1})])]),me,e("p",null,[pe,o(n,{to:"/book/commands/open.html"},{default:s(()=>[_e]),_:1}),ge,fe,xe]),be,we,e("div",ve,[ke,e("p",null,[ye,Ne,Oe,e("a",qe,[Te,o(l)]),Be,o(n,{to:"/book/installation.html"},{default:s(()=>[Le]),_:1}),Se])]),e("p",null,[Ce,o(n,{to:"/book/commands/open.html"},{default:s(()=>[je]),_:1}),Re]),Ie,e("p",null,[We,o(n,{to:"/book/commands/get.html"},{default:s(()=>[Ue]),_:1}),Ae]),Ve,e("p",null,[Je,o(n,{to:"/book/commands/fetch.html"},{default:s(()=>[Ee]),_:1}),Pe]),ze])}const Ge=d(u,[["render",Fe],["__file","loading_data.html.vue"]]);export{Ge as default};
