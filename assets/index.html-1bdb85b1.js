...
</code></pre></div>`,1);function $(H,X){const a=l("RouterLink");return c(),u("div",null,[r,d,m,k,h,s("p",null,[n("当你运行"),e(a,{to:"/book/commands/ls.html"},{default:t(()=>[b]),_:1}),n("这样的命令时，你会注意到的第一件事是，你得到的不是一个文本块，而是一个结构化的表格：")]),_,s("p",null,[n("我们要做的第一件事是按大小对我们的表进行排序。要做到这一点，我们将从"),e(a,{to:"/book/commands/ls.html"},{default:t(()=>[g]),_:1}),n("中获取输出，并将其输入到一个可以根据列的内容对表进行排序的命令中：")]),f,s("p",null,[n("你可以看到，为了达到这个目的，我们没有向"),e(a,{to:"/book/commands/ls.html"},{default:t(()=>[v]),_:1}),n("传递命令行参数。取而代之的是，我们使用了 Nu 提供的"),y,n("命令来对"),e(a,{to:"/book/commands/ls.html"},{default:t(()=>[x]),_:1}),n("命令的输出进行排序。为了在顶部看到最大的文件，我们还使用了"),e(a,{to:"/book/commands/reverse.html"},{default:t(()=>[B]),_:1}),n("命令。")]),s("p",null,[n("Nu 提供了许多可以对表进行操作的命令，例如，我们可以过滤"),e(a,{to:"/book/commands/ls.html"},{default:t(()=>[N]),_:1}),n("表的内容，使其只显示超过 1 千字节的文件。")]),G,s("p",null,[n("如果你使用过 Linux，你可能对"),e(a,{to:"/book/commands/ps.html"},{default:t(()=>[S]),_:1}),n("命令很熟悉。通过它，我们可以得到一个当前系统正在运行的所有进程的列表，它们的状态是什么，以及它们的名字是什么，我们还可以看到这些进程的 CPU 负载。")]),s("p",null,[n("如果我们想显示那些正在活跃使用 CPU 的进程呢？就像我们之前对"),e(a,{to:"/book/commands/ls.html"},{default:t(()=>[w]),_:1}),n("命令所做的那样，我们也可以利用"),e(a,{to:"/book/commands/ps.html"},{default:t(()=>[C]),_:1}),n("命令返回给我们的表格来做到：")]),E,s("p",null,[n("到目前为止，我们一直在使用"),e(a,{to:"/book/commands/ls.html"},{default:t(()=>[M]),_:1}),n("和"),e(a,{to:"/book/commands/ps.html"},{default:t(()=>[U]),_:1}),n("来列出文件和进程。Nu 还提供了其他可以创建有用信息表格的命令。接下来，让我们试一下"),e(a,{to:"/book/commands/date.html"},{default:t(()=>[K]),_:1}),n("和"),e(a,{to:"/book/commands/sys.html"},{default:t(()=>[T]),_:1}),n("。")]),R,s("p",null,[n("运行"),e(a,{to:"/book/commands/sys.html"},{default:t(()=>[j]),_:1}),n("可以得到 Nu 所运行的系统的信息：")]),I,s("p",null,[n("这与我们之前看到的表格有些不同。"),e(a,{to:"/book/commands/sys.html"},{default:t(()=>[A]),_:1}),n("命令输出了一个在单元格中包含结构化表格而非简单值的表格。要查看这些数据，我们需要 "),L,n(" 待查看的列：")]),z,s("p",null,[e(a,{to:"/book/commands/get.html"},{default:t(()=>[q]),_:1}),n('命令让我们深入表的某一列内容中。在这里，我们要查看的是 "host" 列，它包含了 Nu 正在运行的主机的信息：操作系统名称、主机名、CPU，以及更多。让我们来获取系统上的用户名：')]),V,s("p",null,[n("让我们看看字符串在 Nu 外部命令里面是如何工作的。我们以之前的例子为例，运行外部的"),D,n("命令（"),P,n("告诉 Nu 不要使用内置的"),e(a,{to:"/book/commands/echo.html"},{default:t(()=>[F]),_:1}),n("命令）：")]),O,s("p",null,[n("任何 Nu 的内置命令的帮助文本都可以通过"),e(a,{to:"/book/commands/help.html"},{default:t(()=>[Y]),_:1}),n("命令来找到。要查看所有命令，请运行"),J,n("。你也可以通过执行"),Q,n("来搜索一个主题：")]),W])}const ss=p(i,[["render",$],["__file","index.html.vue"]]);export{ss as default};
