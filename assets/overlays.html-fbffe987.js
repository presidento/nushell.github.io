...
`)])],-1),f=e("p",null,[a("We'll use this module throughout the chapter, so whenever you see "),e("code",null,"overlay use spam"),a(", assume "),e("code",null,"spam"),a(" is referring to this module.")],-1),x=e("code",null,"overlay use",-1),_=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> overlay use spam
...
(scratchpad)> def eggs [] { "eggs" }
`)])],-1),M=s(`<h2 id="prefixed-overlays" tabindex="-1"><a class="header-anchor" href="#prefixed-overlays" aria-hidden="true">#</a> Prefixed Overlays</h2><p>The <code>overlay use</code> command would take all commands and aliases from the module and put them directly into the current namespace. However, you might want to keep them as subcommands behind the module&#39;s name. That&#39;s what <code>--prefix</code> is for:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>(zero)&gt; module spam {
    export def foo [] { &quot;foo&quot; }
}
...
───┬──────
 ...
 1 │ zero
───┴──────
</code></pre></div><p>Now, the <code>zero</code> overlay takes precedence.</p>`,18);function S(Y,L){const o=r("RouterLink");return d(),c("div",null,[u,h,e("p",null,[e("em",null,[a("Note: To understand overlays, make sure to check "),t(o,{to:"/book/modules.html"},{default:n(()=>[a("Modules")]),_:1}),a(" first as overlays build on top of modules.")])]),m,e("p",null,[a("First, Nushell comes with one default overlay called "),v,a(". You can inspect which overlays are active with the "),t(o,{to:"/book/commands/overlay_list.html"},{default:n(()=>[p]),_:1}),a(" command. You should see the default overlay listed there.")]),g,y,f,e("p",null,[a("To create the overlay, call "),t(o,{to:"/book/commands/overlay_use.html"},{default:n(()=>[x]),_:1}),a(":")]),_,e("p",null,[a("It brought the module's definitions into the current scope and evaluated the "),b,a(" block the same way as "),w,a(" command would (see "),t(o,{to:"/book/modules.html#environment-variables"},{default:n(()=>[a("Modules")]),_:1}),a(" chapter).")]),z,k,e("p",null,[a("If you don't need the overlay definitions anymore, call "),t(o,{to:"/book/commands/overlay_remove.html"},{default:n(()=>[T]),_:1}),a(":")]),O,q,N,e("p",null,[a("The last way to remove an overlay is to call "),t(o,{to:"/book/commands/overlay_remove.html"},{default:n(()=>[B]),_:1}),a(" without an argument which will remove the last active overlay.")]),I,e("div",A,[C,P,R,E,e("p",null,[a("To make it less verbose, you can use the "),t(o,{to:"/book/commands/overlay_new.html"},{default:n(()=>[F]),_:1}),a(" command:")]),V]),M])}const $=l(i,[["render",S],["__file","overlays.html.vue"]]);export{$ as default};
