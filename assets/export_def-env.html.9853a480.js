import{_ as s,o,c,a,t as n,d as t,e as r}from"./app.873196f3.js";const i={},l={id:"frontmatter-title-for-core",tabindex:"-1"},d=a("a",{class:"header-anchor",href:"#frontmatter-title-for-core","aria-hidden":"true"},"#",-1),p=t(),h=t(" for core"),u={class:"command-title"},f=r(`<h2 id="signature" tabindex="-1"><a class="header-anchor" href="#signature" aria-hidden="true">#</a> Signature</h2><p><code>&gt; export def-env (name) (params) (block)</code></p><h2 id="parameters" tabindex="-1"><a class="header-anchor" href="#parameters" aria-hidden="true">#</a> Parameters</h2><ul><li><code>name</code>: definition name</li><li><code>params</code>: parameters</li><li><code>block</code>: body of the definition</li></ul><h2 id="notes" tabindex="-1"><a class="header-anchor" href="#notes" aria-hidden="true">#</a> Notes</h2><div class="language-text ext-text"><pre class="language-text"><code>This command is a parser keyword. For details, check:
...
</code></pre></div>`,9);function _(e,m){return o(),c("div",null,[a("h1",l,[d,p,a("code",null,n(e.$frontmatter.title),1),h]),a("div",u,n(e.$frontmatter.core),1),f])}const b=s(i,[["render",_],["__file","export_def-env.html.vue"]]);export{b as default};
