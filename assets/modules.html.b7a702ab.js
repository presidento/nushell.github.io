import{_ as l,r as d,o as a,c as r,a as e,b as n,w as s,e as i,d as o}from"./app.213f4294.js";const u={},c=i(`<h1 id="modules" tabindex="-1"><a class="header-anchor" href="#modules" aria-hidden="true">#</a> Modules</h1><p>Similar to many other programming languages, Nushell also has modules that let you import custom commands into a current scope. However, since Nushell is also a shell, modules allow you to import environment variables which can be used to conveniently activate/deactivate various environments.</p><h2 id="basics" tabindex="-1"><a class="header-anchor" href="#basics" aria-hidden="true">#</a> Basics</h2><p>A simple module can be defined like this:</p><div class="language-text ext-text"><pre class="language-text"><code>&gt; module greetings {
...
</code></pre></div><p>We defined <code>hello</code> and <code>hi</code> custom commands inside a <code>greetings</code> module.</p><p>The <code>export</code> keyword makes it possible to later import the commands from the module.</p>`,9),h=o("Similar to "),p=e("code",null,"def",-1),m=o(", it is also possible to mark "),g=e("code",null,"def-env",-1),x=o(" with the "),f=e("code",null,"export",-1),_=o(" keyword (you can learn more about "),v=e("code",null,"def-env",-1),b=o(" in the "),w=o("Environment"),y=o(" chapter)."),q=e("h2",{id:"using-modules",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#using-modules","aria-hidden":"true"},"#"),o(" Using modules")],-1),k=o("By itself, the module does not do anything. To use what the module exports, we need to "),$=e("code",null,"use",-1),E=o(" it."),M=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`> use greetings
...
</code></pre></div>`,11),I=o("Now, you can call "),R=e("code",null,"use",-1),S=o(" directly on the file:"),V=i(`<div class="language-text ext-text"><pre class="language-text"><code>&gt; use greetings.nu
...
</code></pre></div><h2 id="environment-variables" tabindex="-1"><a class="header-anchor" href="#environment-variables" aria-hidden="true">#</a> Environment Variables</h2>`,8),F=o("So far we used modules just to import custom commands. However, modules can also define an environment using "),L=e("code",null,"export-env",-1),j=o(":"),U=i(`<div class="language-text ext-text"><pre class="language-text"><code># greetings.nu
...
</code></pre></div><p>and then use it</p><div class="language-text ext-text"><pre class="language-text"><code>&gt; use purpose.nu
&gt; purpose greeeting_purpose
</code></pre></div><p>However, this won&#39;t work, because the module would not export its environment unless defined manually, like so:</p><div class="language-text ext-text"><pre class="language-text"><code># purpose.nu
