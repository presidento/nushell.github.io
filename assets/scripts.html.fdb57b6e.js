import{_ as r,r as a,o as l,c as d,a as e,b as n,w as o,d as t,e as i}from"./app.dc38b4ed.js";const p={},u=e("h1",{id:"scripts",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#scripts","aria-hidden":"true"},"#"),t(" Scripts")],-1),h=e("p",null,[t("In Nushell, you can write and run scripts in the Nushell language. To run a script, you can pass it as an argument to the "),e("code",null,"nu"),t(" commandline application:")],-1),_=e("div",{class:"language-text ext-text"},[e("pre",{class:"language-text"},[e("code",null,`> nu myscript.nu
`)])],-1),m=t("This will run the script to completion in a new instance of Nu. You can also run scripts inside the "),g=e("em",null,"current",-1),f=t(" instance of Nu using "),x=e("code",null,"source",-1),b=t(":"),w=i(`<div class="language-text ext-text"><pre class="language-text"><code>&gt; source myscript.nu
...
Hello World!
`)])],-1);function $(A,C){const s=a("RouterLink"),c=a("ExternalLinkIcon");return l(),d("div",null,[u,h,_,e("p",null,[m,g,f,n(s,{to:"/book/commands/source.html"},{default:o(()=>[x]),_:1}),b]),w,e("p",null,[v,k,y,N,q,n(s,{to:"/book/pipelines.html#semicolons"},{default:o(()=>[S]),_:1}),T]),L,e("p",null,[I,e("a",V,[W,n(c)]),z,B,E]),H,O])}const R=r(p,[["render",$],["__file","scripts.html.vue"]]);export{R as default};
