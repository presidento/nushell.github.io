...
license = &quot;MIT&quot;
</code></pre></div><h2 id="abriendo-urls" tabindex="-1"><a class="header-anchor" href="#abriendo-urls" aria-hidden="true">#</a> Abriendo URLs</h2><p>Además de cargar archivos desde tu archivos de sistema, también puedes usar el comando <code>http get</code> proporcionando una URL. Se cargará el contenido de la URL por internet y devolverá:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; http get http://www.andresrobalino.com/feed.xml
----------
 rss
----------
 [1 item]
