import{_ as l,M as o,p as d,q as r,Q as s,t as a,N as e,U as c,a1 as n}from"./framework-344bb0e4.js";const i={},u=n(`<h1 id="脚本" tabindex="-1"><a class="header-anchor" href="#脚本" aria-hidden="true">#</a> 脚本</h1><p>在 Nushell 中，你可以用 Nushell 语言编写和运行脚本。要运行一个脚本，你可以把它作为一个参数传递给<code>nu</code>命令行程序：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> nu myscript.nu
...
</code></pre></div>`,3);function q(y,w){const t=o("RouterLink"),p=o("ExternalLinkIcon");return d(),r("div",null,[u,s("p",null,[a("这将在一个新的 Nu 实例中运行脚本直至完成。你也可以使用"),e(t,{to:"/book/commands/source.html"},{default:c(()=>[h]),_:1}),a("在 Nu 的 "),g,a(" 实例中运行脚本：")]),k,s("p",null,[a("当这个脚本运行时，Nushell 将首先运行"),_,a("命令至完成并查看其结果。接下来，Nushell 将按照"),e(t,{to:"/zh-CN/book/types_of_data.html#%E7%BB%84"},{default:c(()=>[a('"组"部分')]),_:1}),a("中的规则运行"),b,a("。")]),m,s("p",null,[a("在 Linux 和 macOS 上，你可以选择使用 "),s("a",x,[a("Shebang"),e(p)]),a("来告诉操作系统一个文件应该被 "),v,a(" 解释。例如，在一个名为 "),f,a(" 的文件中包含以下内容：")]),N])}const L=l(i,[["render",q],["__file","scripts.html.vue"]]);export{L as default};
