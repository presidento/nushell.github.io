import{_ as l,M as i,p as d,q as r,Q as e,t,N as n,U as s,a1 as o}from"./framework-344bb0e4.js";const c={},h=o(`<h1 id="working-with-tables" tabindex="-1"><a class="header-anchor" href="#working-with-tables" aria-hidden="true">#</a> Working with tables</h1><p>One of the common ways of seeing data in Nu is through a table. Nu comes with a number of commands for working with tables to make it convenient to find what you&#39;re looking for, and for narrowing down the data to just what you need.</p><p>To start off, let&#39;s get a table that we can use:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls
───┬───────────────┬──────┬─────────┬────────────
...
───┼───┼───
 ...
 1 │ 3 │ 4
───┴───┴───
`)])],-1),D=e("h3",{id:"merging-tables",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#merging-tables","aria-hidden":"true"},"#"),t(" Merging Tables")],-1),q=e("code",null,"merge",-1),I=o(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; let $first = [[a b]; [1 2]]
&gt; let $second = [[c d]; [3 4]]
&gt; $first | merge $second 
───┬───┬───┬───┬───
 # │ a │ b │ c │ d
...
───┼───┼───┼───┼───┼───┼───
 0 │ 1 │ 2 │ 3 │ 4 │ 5 │ 6
───┴───┴───┴───┴───┴───┴───
</code></pre></div>`,5),Y=e("code",null,"reduce",-1),C=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> [$first $second $third] | reduce {|it, acc| $acc | merge $it }
───┬───┬───┬───┬───┬───┬───
 # │ a │ b │ c │ d │ e │ f
───┼───┼───┼───┼───┼───┼───
 0 │ 1 │ 2 │ 3 │ 4 │ 5 │ 6
───┴───┴───┴───┴───┴───┴───
`)])],-1),S=e("h3",{id:"adding-a-new-column",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#adding-a-new-column","aria-hidden":"true"},"#"),t(" Adding a new column")],-1),j=e("code",null,"insert",-1),A=o(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open rustfmt.toml
─────────┬──────
 edition │ 2018
─────────┴──────
...
─────────┬──────
 edition │ 2018
─────────┴──────
</code></pre></div>`,7),V=e("code",null,"save",-1),M=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> open rustfmt.toml | insert next_edition 2021 | save rustfmt2.toml
> open rustfmt2.toml
──────────────┬──────
 edition      │ 2018
 next_edition │ 2021
──────────────┴──────
`)])],-1),R=e("h3",{id:"updating-a-column",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#updating-a-column","aria-hidden":"true"},"#"),t(" Updating a column")],-1),O=e("code",null,"insert",-1),U=e("code",null,"update",-1),E=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> open rustfmt.toml
─────────┬──────
 edition │ 2018
─────────┴──────
`)])],-1),G=e("p",null,"And now, let's update the edition to point at the next edition we hope to support:",-1),H=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> open rustfmt.toml | update edition 2021
─────────┬──────
 edition │ 2021
─────────┴──────
`)])],-1),Q=e("code",null,"upsert",-1),J=o(`<h3 id="moving-columns" tabindex="-1"><a class="header-anchor" href="#moving-columns" aria-hidden="true">#</a> Moving columns</h3><p>You can use <code>move</code> to move columns in the table. For example, if we wanted to move the &quot;name&quot; column from <code>ls</code> after the &quot;size&quot; column, we could do:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls | move name --after size
╭────┬──────┬─────────┬───────────────────┬──────────────╮
