import{_ as s,z as d,A as i,X as e,C as a,T as n,$ as o,a6 as l,Q as c}from"./framework.3d018c9f.js";const r={},u=l(`<h1 id="custom-commands" tabindex="-1"><a class="header-anchor" href="#custom-commands" aria-hidden="true">#</a> Custom commands</h1><p>Nu&#39;s ability to compose long pipelines allows you a lot of control over your data and system, but it comes at the price of a lot of typing. Ideally, you&#39;d be able to save your well-crafted pipelines to use again and again.</p><p>This is where custom commands come in.</p><p>An example definition of a custom command:</p><div class="language-nushell" data-ext="nushell"><pre class="language-nushell"><code>def greet [name] {
  [&#39;hello&#39; $name]
}
...
</code></pre></div>`,96),p=e("code",null,"ls",-1),h=e("div",{class:"language-nushell","data-ext":"nushell"},[e("pre",{class:"language-nushell"},[e("code",null,`def my-ls [] { ls }
`)])],-1),m=e("code",null,"ls",-1),g=l(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; my-ls | get name
───┬───────────────────────
 0 │ myscript.nu
 1 │ myscript2.nu
...
</code></pre></div><h2 id="persisting" tabindex="-1"><a class="header-anchor" href="#persisting" aria-hidden="true">#</a> Persisting</h2>`,11);function f(v,x){const t=c("RouterLink");return d(),i("div",null,[u,e("p",null,[a("Let's move "),n(t,{to:"/book/commands/ls.html"},{default:o(()=>[p]),_:1}),a(" into a command that we've written:")]),h,e("p",null,[a("We can use the output from this command just as we would "),n(t,{to:"/book/commands/ls.html"},{default:o(()=>[m]),_:1}),a(".")]),g,e("p",null,[a("For information about how to persist custom commands so that they're visible when you start up Nushell, see the "),n(t,{to:"/book/configuration.html"},{default:o(()=>[a("configuration chapter")]),_:1}),a(" and add your startup script.")])])}const y=s(r,[["render",f],["__file","custom_commands.html.vue"]]);export{y as default};
