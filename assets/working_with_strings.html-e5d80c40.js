...
</code></pre></div><h3 id="reversing-strings" tabindex="-1"><a class="header-anchor" href="#reversing-strings" aria-hidden="true">#</a> Reversing strings</h3>`,2),q=s("code",null,"str reverse",-1),N=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&#39;Nushell&#39;</span> <span class="token operator">|</span> str reverse
llehsuN
