...
</code></pre></div><h2 id="获取-urls" tabindex="-1"><a class="header-anchor" href="#获取-urls" aria-hidden="true">#</a> 获取 URLs</h2>`,2),z=t("code",null,"http get",-1),E=t("div",{class:"language-text","data-ext":"text"},[t("pre",{class:"language-text"},[t("code",null,`> http get https://blog.rust-lang.org/feed.xml
──────┬───────────────────
