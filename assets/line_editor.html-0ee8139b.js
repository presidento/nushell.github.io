...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">..</span>.
  <span class="token punctuation">}</span>
</code></pre></div>`,127);function h(m,k){const t=s("ExternalLinkIcon");return o(),i("div",null,[d,e("p",null,[n("Nushell's line editor "),e("a",r,[n("Reedline"),p(t)]),n(" is a cross-platform line reader designed to be modular and flexible. The engine is in charge of controlling the command history, validations, completions, hints and screen paint.")]),u])}const y=a(l,[["render",h],["__file","line_editor.html.vue"]]);export{y as default};
