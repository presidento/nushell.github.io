...
───────┴────
`)])],-1),x=e("p",null,`The span "start" and "end" here refer to where the underline will be in the line. If you count over 5, and then count up to 15, you'll see it lines up with the "Cargo.toml" filename. This is how the error we saw earlier knew what to underline.`,-1);function k(v,y){const a=n("RouterLink");return s(),l("div",null,[d,c,u,m,g,e("p",null,[t("Let's run the "),r(a,{to:"/book/commands/open.html"},{default:i(()=>[p]),_:1}),t(" command again, but this time, we'll look at the tags it gives back:")]),_,f,w,x])}const C=o(h,[["render",k],["__file","metadata.html.vue"]]);export{C as default};
