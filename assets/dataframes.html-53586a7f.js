...
───┴───┴───┴─────────┴────────
</code></pre></div><p>为了创建复杂的掩码，我们可以使用<code>AND</code>：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token variable">$mask</span> <span class="token operator">&amp;&amp;</span> <span class="token variable">$mask1</span>
...
───┼──────────────────
 ...
 <span class="token number">2</span> │ <span class="token boolean">false</span>
───┴──────────────────
</code></pre></div><p>或者 <code>OR</code> 操作：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token variable">$mask</span> <span class="token operator">||</span> <span class="token variable">$mask1</span>
