...
───┴───────┴──────┴─────────
</code></pre></div>`,80),L=a("strong",null,"Apache Arrow",-1),C=a("strong",null,"Polars",-1),I={href:"https://arrow.apache.org/docs/format/Columnar.html",target:"_blank",rel:"noopener noreferrer"},j=a("code",null,"$a",-1),W=a("code",null,"$a2",-1),P=a("code",null,"into df",-1),R=t(`<h2 id="working-with-series" tabindex="-1"><a class="header-anchor" href="#working-with-series" aria-hidden="true">#</a> Working with Series</h2><p>A <code>Series</code> is the building block of a <code>DataFrame</code>. Each Series represents a column with the same data type, and we can create multiple Series of different types, such as float, int or string.</p><p>Let&#39;s start our exploration with Series by creating one using the <code>into df</code> command:</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token builtin class-name">let</span> new <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token number">9</span> <span class="token number">8</span> <span class="token number">4</span><span class="token punctuation">]</span> <span class="token operator">|</span> into <span class="token function">df</span><span class="token punctuation">)</span>
...
───┴───┴───┴─────────┴────────
</code></pre></div><p>To create complex masks, we have the <code>AND</code></p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token variable">$mask</span> and <span class="token variable">$mask1</span>
...
───┼──────────────────
 ...
 <span class="token number">2</span> │ <span class="token boolean">false</span>
───┴──────────────────
</code></pre></div><p>and <code>OR</code> operations</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token variable">$mask</span> or <span class="token variable">$mask1</span>
