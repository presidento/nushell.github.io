...
───┴───────────────┴──────┴─────────┴────────────
`)])],-1),h=s("p",null,'我们可以通过任何可以比较的列来对一个表进行排序。例如，我们也可以用 "name", "accessed" 或者 "modified" 列对上述内容进行排序。',-1),m=s("h2",{id:"选取",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#选取","aria-hidden":"true"},"#"),a(" 选取")],-1),k=s("code",null,"select",-1),_=o(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls | select name size
───┬───────────────┬─────────
 # │ name          │ size
───┼───────────────┼─────────
 0 │ files.rs      │  4.6 KB
...
───┴───────────────┴──────┴─────────┴────────────
</code></pre></div><h2 id="从表格提取数据" tabindex="-1"><a class="header-anchor" href="#从表格提取数据" aria-hidden="true">#</a> 从表格提取数据</h2>`,10),b=s("code",null,"get",-1),x=s("div",{class:"language-text","data-ext":"text"},[s("pre",{class:"language-text"},[s("code",null,`> ls | get name
───┬───────────────
 0 │ files.rs
 1 │ lib.rs
 2 │ lite_parse.rs
...
...
</code></pre></div>`,6);function W(X,Y){const n=p("RouterLink");return c(),d("div",null,[r,s("p",null,[a("我们可以通过调用"),e(n,{to:"/book/commands/sort-by.html"},{default:t(()=>[u]),_:1}),a("命令对一个表进行排序，并指定需要排序的列。比如，按照文件的大小对表格进行排序：")]),g,h,m,s("p",null,[a("我们可以从表中通过选择特定的列或行来获得数据。让我们从表中选择（"),e(n,{to:"/book/commands/select.html"},{default:t(()=>[k]),_:1}),a("）几列吧：")]),_,s("p",null,[a("到目前为止，我们在处理表格时都是将表格修剪成我们需要的样子。有时我们可能想更进一步，只看单元格本身的值，而不是取整列。比如，我们只想得到一个包含所有文件名的列表。在此，我们使用"),e(n,{to:"/book/commands/get.html"},{default:t(()=>[b]),_:1}),a(" 命令：")]),x,f,s("p",null,[a("这可能看起来很像我们之前使用的"),e(n,{to:"/book/commands/select.html"},{default:t(()=>[v]),_:1}),a("命令，所以也把它放在这里以便于比较：")]),y,B,s("ul",null,[s("li",null,[e(n,{to:"/book/commands/select.html"},{default:t(()=>[K]),_:1}),a(" - 创建一个只包括指定列的新表；")]),s("li",null,[e(n,{to:"/book/commands/get.html"},{default:t(()=>[F]),_:1}),a(" - 以列表形式返回指定列内的值；")])]),$,s("p",null,[e(n,{to:"/book/commands/get.html"},{default:t(()=>[z]),_:1}),a("命令可以更进一步，它可以接受表中更深的数据路径。这简化了对复杂数据的处理，比如那些你可能在.json 文件中发现的结构。")]),w,N,D,s("p",null,[a("我们可以使用"),e(n,{to:"/book/commands/append.html"},{default:t(()=>[q]),_:1}),a("将列名相同的表拼接起来：")]),V,A,s("p",null,[a("我们可以使用"),e(n,{to:"/book/commands/merge.html"},{default:t(()=>[C]),_:1}),a("命令将两个（或多个）表格合并在一起：")]),L,s("p",null,[a("或者我们可以使用"),e(n,{to:"/book/commands/reduce.html"},{default:t(()=>[R]),_:1}),a("命令来动态地合并所有的表格：")]),j,s("p",null,[a("我们可以使用"),e(n,{to:"/book/commands/insert.html"},{default:t(()=>[E]),_:1}),a("命令在表中增加新列，让我们看一个例子：")]),M,s("p",null,[a("Nu 的更改是函数性更改，这意味着它们只在值上起作用，而不是试图引起永久性变更。这使我们可以在管道中进行许多不同类型的操作直到我们准备好将结果输出(如果我们选择这样做的话)。这里我们可以使用 "),e(n,{to:"/book/commands/save.html"},{default:t(()=>[Q]),_:1}),a(" 命令保存结果：")]),S,T,s("p",null,[a("与"),e(n,{to:"/book/commands/insert.html"},{default:t(()=>[U]),_:1}),a("命令类似，我们也可以使用"),e(n,{to:"/book/commands/update.html"},{default:t(()=>[G]),_:1}),a("命令将某一列的内容修改为新值。为了看看效果，让我们打开同一个文件：")]),H,I,J,s("p",null,[a("你也可以使用"),e(n,{to:"/book/commands/upsert.html"},{default:t(()=>[O]),_:1}),a("命令来插入或更新，这取决于该列是否已经存在。")]),P])}const ss=l(i,[["render",W],["__file","working_with_tables.html.vue"]]);export{ss as default};
