import{_ as s,r as d,o as i,c,a as e,b as n,w as o,e as l,d as a}from"./app.ed35f534.js";const r={},u=l(`<h1 id="custom-commands" tabindex="-1"><a class="header-anchor" href="#custom-commands" aria-hidden="true">#</a> Custom commands</h1><p>Nu&#39;s ability to compose long pipelines allows you a lot of control over your data and system, but it comes at the price of a lot of typing. Ideally, you&#39;d be able to save your well-crafted pipelines to use again and again.</p><p>This is where custom commands come in.</p><p>An example definition of a custom command:</p><div class="language-nushell ext-nushell"><pre class="language-nushell"><code>def greet [name] {
  [&#39;hello&#39; $name]
}
...
</code></pre></div>`,96),p=a("Let's move "),h=e("code",null,"ls",-1),m=a(" into a command that we've written:"),g=e("div",{class:"language-nushell ext-nushell"},[e("pre",{class:"language-nushell"},[e("code",null,`def my-ls [] { ls }
...
</code></pre></div><h2 id="persisting" tabindex="-1"><a class="header-anchor" href="#persisting" aria-hidden="true">#</a> Persisting</h2>`,11),y=a("For information about how to persist custom commands so that they're visible when you start up Nushell, see the "),b=a("configuration chapter"),$=a(" and add your startup script.");function _(q,k){const t=d("RouterLink");return i(),c("div",null,[u,e("p",null,[p,n(t,{to:"/book/commands/ls.html"},{default:o(()=>[h]),_:1}),m]),g,e("p",null,[f,n(t,{to:"/book/commands/ls.html"},{default:o(()=>[v]),_:1}),x]),w,e("p",null,[y,n(t,{to:"/book/configuration.html"},{default:o(()=>[b]),_:1}),$])])}const I=s(r,[["render",_],["__file","custom_commands.html.vue"]]);export{I as default};
